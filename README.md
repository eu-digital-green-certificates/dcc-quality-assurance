...
This repository contains a curated selection of verified testdata signed with keys from the DCC ACC environment. All DCC variations found in this repository are either in production or soon to be in production and all DCC verifier apps should be able to decode and verify them. Some DCCs might be expired (with valid signature).
